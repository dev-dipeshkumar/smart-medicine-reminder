...
export const mockBackend: backendInterface = {
  ...
  registerPushSubscription: async () => ({ __kind__: "ok" as const, ok: null }),
  setVapidPublicKey: async () => undefined,
  unregisterPushSubscription: async () => ({ __kind__: "ok" as const, ok: null }),
