...
import { HeartPulse, Mail, Lock, Eye, EyeOff, ArrowRight, CheckCircle } from 'lucide-react';
...
function LoginContent() {
  ...
  // Don't render the form if user exists
  if (user) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // On success, the login function handles redirect
  };
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl xl:text-5xl font-bold text-white leading-tight">
                Welcome Back to<br />
                <span className="text-cyan-100">Smart Healthcare</span>
              </h1>
              <p className="text-lg text-white/80 max-w-md">
                Sign in to continue your health journey with AI-powered medicine reminders.
              </p>
            </div>
            ...
            <div className="space-y-4">
              {[
                ...
                { icon: '✓', text: 'Emergency Support 24/7' },
              ].map((feature, index) => (
                <div 
                  key={feature.text}
